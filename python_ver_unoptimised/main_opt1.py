...
#axs[1,1].plot(t,t,color = 'red',label = 'y = t')
#axs[1,1].plot(t,t**1/3,color = 'blue',label = 'y = t**1/3')
...
savetxt('time.csv', t, delimiter=',')
savetxt('radius.csv', mean_radius, delimiter=',')
